...
public class DlgAddModifyColor extends JDialog {
	...
	public DlgAddModifyColor() {
		...
		gbl_contentPanel.columnWidths = new int[]{72, 0, 0};
		gbl_contentPanel.rowHeights = new int[]{28, 22, 21, 0};
		...
		}
		{
			...
			gbc_txtRed.anchor = GridBagConstraints.NORTH;
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(Integer.parseInt(txtRed.getText())>=0
								& Integer.parseInt(txtRed.getText())<=255) {
							ok=true;
							setVisible(false);
						}else {
							JOptionPane.showMessageDialog(null, "Vrednosti nisu dobre",
